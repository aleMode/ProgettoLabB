...
public class Menù_Cittadini extends JFrame {
	...
	public Menù_Cittadini() {
		...
		Scritta1.setBounds(106, 42, 340, 28);
		...
		Consulta.setBounds(10, 111, 300, 60);
		...
		Registrati.setBounds(10, 182, 300, 60);
		...
		Effetti_Collaterali.setBounds(10, 255, 300, 60);
		...
		txtrCercaUnCentro.setText("Cerca un Centro Vaccinale per nome o per \r\ncomune e tipologia.");
		txtrCercaUnCentro.setBounds(320, 111, 255, 60);
		...
		txtrRegistrarsi.setBounds(320, 182, 255, 60);
		...
		txtrInserireEffetti.setText("Per inserire degli effetti collaterali \r\npost-vaccinazione bisogna avere in possesso Username e Passowrd.");
		txtrInserireEffetti.setBounds(320, 255, 255, 60);
